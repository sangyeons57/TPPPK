...
import com.example.domain_repository.base.ChatCacheRepository
import com.example.domain_repository.base.MessageRepository
import com.example.domain_repository.context.AuthRepositoryFactoryContext
import com.example.domain_repository.context.ChatCacheRepositoryFactoryContext
import com.example.domain_repository.context.MessageRepositoryFactoryContext
...
class ChatUseCaseProvider @Inject constructor(
    ...
    fun createForChannel(projectId: String, channelId: String): ChatUseCases {
        ...
        return ChatUseCases(
            sendMessageUseCase = SendMessageUseCase(messageRepository, outBoxRepository),
