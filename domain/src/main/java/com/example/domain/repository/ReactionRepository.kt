...
interface ReactionRepository {
     ...
     */
    fun getReactionsStream(messageId: String): Flow<CustomResult<List<Reaction>, Unit>>
     ...
     */
    suspend fun addReaction(messageId: String, userId: String, emoji: String): CustomResult<Reaction, Unit>
     ...
     */
    suspend fun removeReaction(reactionId: String): CustomResult<Unit, Unit>
