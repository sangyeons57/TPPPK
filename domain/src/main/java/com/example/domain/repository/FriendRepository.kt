...
interface FriendRepository {
     ...
     */
    fun getFriendRequestsStream(currentUserId: String): Flow<CustomResult<List<Friend>, Exception>>
     ...
     */
    suspend fun sendFriendRequest(user: UserSession, receiverId: String): CustomResult<Unit, Exception>
