...
interface UpdateScheduleUseCase {
    suspend operator fun invoke(schedule: Schedule): CustomResult<DocumentId, Exception>
}
class UpdateScheduleUseCaseImpl @Inject constructor(
    private val scheduleRepository: ScheduleRepository
) : UpdateScheduleUseCase {
    override suspend operator fun invoke(schedule: Schedule): CustomResult<DocumentId, Exception> {
