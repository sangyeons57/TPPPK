...
//     // ... other methods
//     fun createDirectChannel(projectId: String, name: String, mode: ChannelMode, order: Int): Result<Channel> // Or ProjectChannelModel
// }
...
class CreateDirectChannelUseCase @Inject constructor(
     ...
     */
    suspend operator fun invoke(projectId: String, name: String, mode: ChannelMode, order: Int): Result<Channel> { // TODO: Consider Result<ProjectChannelModel>
        ...
        // Changed from projectRepository.createDirectChannel to projectStructureRepository.createDirectChannel
        return projectStructureRepository.createDirectChannel(projectId, name.trim(), mode, order)
    }
}