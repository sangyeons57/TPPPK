package com.example.core_navigation.routes // Correct package
...
object AppRoutes {
    ...
    object MainScreens {
        ...
        object Calendar {
            ...
            val scheduleDetailArguments = listOf(navArgument(ARG_SCHEDULE_ID) { type = NavType.StringType })

            fun editSchedule(scheduleId: String) = "schedule/edit/$scheduleId"
            fun editScheduleRoute() = "schedule/edit/{$ARG_SCHEDULE_ID}"
            val editScheduleArguments = listOf(navArgument(ARG_SCHEDULE_ID) { type = NavType.StringType })
    ...
    object Project {
        ...
        val detailArguments = listOf(navArgument(ARG_PROJECT_ID) { type = NavType.StringType })

        // Project Settings (Root)
        fun settings(projectId: String) = "$ROOT/$projectId/settings"
        fun settingsRoute() = "$ROOT/{$ARG_PROJECT_ID}/settings"
        val settingsArguments = listOf(navArgument(ARG_PROJECT_ID) { type = NavType.StringType })
        ...
        val createCategoryArguments = listOf(navArgument(ARG_PROJECT_ID) { type = NavType.StringType })
        ...
        val memberListArguments = listOf(navArgument(ARG_PROJECT_ID) { type = NavType.StringType })
        ...
        val roleListArguments = listOf(navArgument(ARG_PROJECT_ID) { type = NavType.StringType })
        ...
        fun editRoleRoute() = "$ROOT/{$ARG_PROJECT_ID}/roles/edit/{$ARG_ROLE_ID}"
         val editRoleArguments = listOf(
            navArgument(ARG_PROJECT_ID) { type = NavType.StringType },
            navArgument(ARG_ROLE_ID) { type = NavType.StringType } // Assuming roleId is part of path for edit
        )
    ...
    object User { // For user-specific screens not tied to a project directly or main tabs
        ...
        val profileArguments = listOf(navArgument(ARG_USER_ID) { type = NavType.StringType })
    }
    ...
    object Chat {
        ...
        val channelArguments = listOf(navArgument(ARG_CHANNEL_ID) { type = NavType.StringType })
