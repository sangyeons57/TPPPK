...
include(":feature:feature_channel_edit")
include(":feature:feature_category_edit")
...
include(":feature:feature_member")
...
include(":feature:feature_create_channel")
include(":feature:feature_create_category")
