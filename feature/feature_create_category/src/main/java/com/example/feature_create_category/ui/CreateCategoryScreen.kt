package com.example.feature_create_category.ui
...
import com.example.feature_create_category.viewmodel.CreateCategoryEvent
import com.example.feature_create_category.viewmodel.CreateCategoryUiState
import com.example.feature_create_category.viewmodel.CreateCategoryViewModel
...
fun CreateCategoryScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.eventFlow.collectLatest { event ->
            when (event) {
                is CreateCategoryEvent.NavigateBack -> navigationManger.navigateBack()
