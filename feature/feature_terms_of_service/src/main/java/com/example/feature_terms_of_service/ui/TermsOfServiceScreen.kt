package com.example.feature_terms_of_service.ui
...
import com.example.feature_terms_of_service.viewmodel.TermsOfServiceEvent
import com.example.feature_terms_of_service.viewmodel.TermsOfServiceViewModel
import kotlinx.coroutines.flow.collectLatest

/**
 * 서비스 이용약관 화면 (Stateful)
 * @param navigationManger 네비게이션 처리를 위한 AppNavigator
...
fun TermsOfServiceScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.eventFlow.collectLatest { event ->
            when (event) {
                is TermsOfServiceEvent.NavigateBack -> navigationManger.navigateBack()
