package com.example.feature_privacy_policy.ui
...
import com.example.feature_privacy_policy.viewmodel.PrivacyPolicyEvent
import com.example.feature_privacy_policy.viewmodel.PrivacyPolicyViewModel
...
fun PrivacyPolicyScreen(
    ...
    LaunchedEffect(Unit) {
        viewModel.eventFlow.collectLatest { event ->
            when (event) {
                is PrivacyPolicyEvent.NavigateBack -> navigationManger.navigateBack()
