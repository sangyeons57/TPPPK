...
class ChatRepositoryTest {
     ...
     */
    @Test
    fun testMessagesStreamReturnsMessagesForChannel() {
        runBlocking {
            // When: 메시지 스트림 가져오기
     ...
     */
    @Test
    fun testEmptyChannelReturnsEmptyList() {
        runBlocking {
            // Given: 비어있는 채널
     ...
     */
    @Test
    fun testPastMessagesBeforeGivenId() {
        runBlocking {
            // Given: 추가 메시지 설정
     ...
     */
    @Test
    fun testFetchPastMessagesRespectsLimit() {
        runBlocking {
            // Given: 여러 메시지 추가
     ...
     */
    @Test
    fun testSendMessageAddsNewMessageAndReturnsIt() {
        runBlocking {
            // Given: 전송할 메시지 데이터
     ...
     */
    @Test
    fun testSendMessageFailsWithEmptyContent() {
        runBlocking {
            // Given: 빈 메시지와 빈 첨부파일
            val emptyMessage = "   "
     ...
     */
    @Test
    fun testEditMessageUpdatesContent() {
        runBlocking {
            // Given: 수정할 새 메시지 내용
     ...
     */
    @Test
    fun testEditMessageFailsForNonExistentMessage() {
        runBlocking {
            // When: 존재하지 않는 메시지 수정
     ...
     */
    @Test
    fun testDeleteMessageRemovesFromChannel() {
        runBlocking {
            // When: 메시지 삭제
     ...
     */
    @Test
    fun testDeleteMessageFailsForNonExistentMessage() {
        runBlocking {
            // When: 존재하지 않는 메시지 삭제
     ...
     */
    @Test
    fun testGalleryImagesReturnsPaginatedResults() {
        runBlocking {
            // Given: 테스트 갤러리 이미지
     ...
     */
    @Test
    fun testGalleryImagesEmptyForOutOfRangePage() {
        runBlocking {
            // Given: 테스트 갤러리 이미지
     ...
     */
    @Test
    fun testRepositoryPropagatesSimulatedErrors() {
        runBlocking {
            // Given: 에러 시뮬레이션 설정
