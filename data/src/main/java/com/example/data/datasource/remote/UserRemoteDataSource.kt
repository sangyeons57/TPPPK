...
interface UserRemoteDataSource {
     ...
     */
    suspend fun getMyUserInfo(): Result<UserDTO>

    /**
     * 특정 userId를 가진 사용자의 정보를 실시간으로 관찰합니다.
     * @param userId 관찰할 사용자의 ID
     */
    fun observeUser(userId: String): Flow<Result<UserDTO>>
     ...
     */
    suspend fun searchUsersByName(nameQuery: String): Result<List<UserDTO>>
