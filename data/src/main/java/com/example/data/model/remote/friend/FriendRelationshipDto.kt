...
data class FriendRelationshipDto(
    ...
    @get:PropertyName(FirestoreConstants.FriendFields.STATUS)
    @set:PropertyName(FirestoreConstants.FriendFields.STATUS)
    var status: FriendRequestStatus = FriendRequestStatus.UNKNOWN, // e.g., "pending_sent", "pending_received", "accepted"

    @get:PropertyName(FirestoreConstants.FriendFields.TIMESTAMP)
    @set:PropertyName(FirestoreConstants.FriendFields.TIMESTAMP)
    ...
    @get:PropertyName(FirestoreConstants.FriendFields.ACCEPTED_AT)
    @set:PropertyName(FirestoreConstants.FriendFields.ACCEPTED_AT)
    ...
    fun toBasicDomainModel(ownerUserId: String): FriendRelationship {
        ...
        return FriendRelationship(
            ...
            status = this.status, // Convert String to Enum
